...
/*
    ...
    httpServer.route({
            ...
            console.log('Route:', data.protocol)
            console.log('Route:', data.host)
            console.log('Route:', data.port)
            console.log('Route:', data.uri)
            console.log('Route:', data.method)
            console.log('Route:', data.headers)
            console.log('Route:', data.headersSize)
            console.log('Route:', data.bodyInFile)
            console.log('Route:', data.body) // If data.bodyInFile is true, data.body = path to file.
            if (!data.bodyInFile) {
                console.log('Route string body:', Buffer.from(data.body, 'binary').toString())
            }
            console.log('Route:', data.bodySize)
            console.log('Route:', data.ip)
